...
SCRATCH=${SCRATCH:-/usr/share/nginx/html}
...
curl -sS -n 'https://dhr1.cesnet.cz/search?q=footprint:%22Intersects('$COORDS')%22%20AND%20platformname:Sentinel-2%20AND%20producttype:S2MSI2Ap%20AND%20beginPosition:%5b2020-09-20T00:00:00.000Z%20TO%20NOW%5d&start=0&rows=100' > step1.$$.xml
